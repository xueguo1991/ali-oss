...
async function putChannel(id, conf, options = {}) {
    options.subres = 'live';
    const params = _objectRequestParams_1._objectRequestParams('PUT', id, options);
...
async function getChannel(id, options = {}) {
    options.subres = 'live';
    const params = _objectRequestParams_1._objectRequestParams('GET', id, options);
    params.xmlResponse = true;
    params.successStatuses = [200];
    const result = await this.request(params);
    return {
...
async function deleteChannel(id, options = {}) {
    options.subres = 'live';
    const params = _objectRequestParams_1._objectRequestParams('DELETE', id, options);
...
async function listChannels(query, options = {}) {
    ...
    options.subres = 'live';
    const params = _objectRequestParams_1._objectRequestParams('GET', '', options);
    params.query = query;
    params.xmlResponse = true;
    params.successStatuses = [200];
    const result = await this.request(params);
...
async function createVod(id, name, time, options = {}) {
    ...
    const params = _objectRequestParams_1._objectRequestParams('POST', `${id}/${name}`, options);
    params.query = time;
    params.successStatuses = [200];
    const result = await this.request(params);
    return {
